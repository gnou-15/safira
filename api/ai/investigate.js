...
export default async function handler(req, res) {
  ...
  try {
    const response = await fetch(`${PYTHON_SERVICE_URL}/generate-investigation`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ executive_summary, id_number, position, date_of_hiring, trainings })
    });
    ...
    console.error('AI investigate proxy error:', error);
