...
export default function Header({
  ...
  return (
    <header className={`top-nav ${(!currentReport && !currentInvestigation && currentPage !== 'activity') ? 'top-nav-landing' : ''}`}>
      {currentPage === 'activity' ? (
        <>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <div className="logo-container logo-container-edit" onClick={() => handleNavigate ? handleNavigate('landing') : setCurrentPage('landing')} style={{ display: 'flex', alignItems: 'center', gap: '4px', cursor: 'pointer' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', position: 'relative' }}>
              <div className="custom-report-selector">
                <button type="button" className="custom-select-trigger active" style={{ cursor: 'default' }}>
                  <span className="trigger-text">User Activity & Key Sessions</span>
                </button>
              </div>
              <div className="header-save-status">
                <span className="status-saved">Live</span>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <button
              ...
              onClick={() => handleNavigate ? handleNavigate('landing') : setCurrentPage('landing')}
            >
              ← Back
            </button>
          </div>
        ...
        <>
          <div className="logo-container logo-container-landing" onClick={() => { if (handleNavigate) { handleNavigate('landing'); } else if (setCurrentPage) { setCurrentPage('landing'); } fetchReports(); }}>
            <div className="safira-logo-wrapper">
              <svg viewBox="0 0 100 100" className="safira-logo" width="30" height="30">
                <defs>
                  <filter id="logo-glow-ed" x="-20%" y="-20%" width="140%" height="140%">
